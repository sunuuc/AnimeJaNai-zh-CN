"""Publish the verified Windows package and save the exact UI sources used to build it."""
...
expected={p.name for p in user_assets+[sourcezip,checksums]}
actual={a['name'] for a in uploaded['assets']}
