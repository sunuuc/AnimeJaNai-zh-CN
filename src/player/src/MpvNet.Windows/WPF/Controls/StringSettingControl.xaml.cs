...
public partial class StringSettingControl : UserControl, ISettingControl
{
    ...
    public StringSettingControl(StringSetting stringSetting)
    {
        ...
        InitializeComponent();
        DataContext = this;
        TitleTextBox.Text = AnimeJaNai.Localization.UiText.T(stringSetting.Name) == stringSetting.Name ? stringSetting.Name : AnimeJaNai.Localization.UiText.T(stringSetting.Name) + " (" + stringSetting.Name + ")";
        HelpTextBox.Text = AnimeJaNai.Localization.UiText.T(stringSetting.Help);
